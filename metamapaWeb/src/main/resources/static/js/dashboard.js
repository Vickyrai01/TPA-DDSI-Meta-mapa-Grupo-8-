...
filtroSel.addEventListener('change', function() {
    ...
    document.getElementById('csv-prov-categ').href = `http://18.224.251.228:8090/servicioEstadisticas/export/csv/provincia-por-categoria/${encodeURIComponent(cat)}`;
    document.getElementById('csv-hora-categ').href = `http://18.224.251.228:8090/servicioEstadisticas/export/csv/horario-por-categoria/${encodeURIComponent(cat)}`;
