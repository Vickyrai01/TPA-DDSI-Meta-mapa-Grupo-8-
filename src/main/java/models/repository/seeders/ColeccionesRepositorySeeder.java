...
public class ColeccionesRepositorySeeder {
    ...
    Coleccion coleccion1 = new Coleccion(1, "Incendios", "Incendios de cualquier objeto", null, coleccionHechos1, null);
    Coleccion coleccion2 = new Coleccion(2, "Choques", "Todos los choques",  null, coleccionHechos2, null);
    Coleccion coleccion3 = new Coleccion(3, "Sin victimas fatales", "Accidentes de cualquier tipo sin accidentes", null, coleccionHechos3, null);
